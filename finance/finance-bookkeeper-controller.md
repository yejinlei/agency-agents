...
- **Cash Management**: Daily cash position 追踪, bank reconciliations, cash forecasting, wire/ACH processing
...
- [ ] 审查 and post employee expense reports
- [ ] Verify AR invoices issued for all delivered goods/服务s
...
- [ ] Calculate and post expense accruals (utilities, professional 服务s, commissions)
...
- [ ] Prepare 现金流 statement (direct or indirect method)
- [ ] Prepare 支持 schedules (debt, equity, deferred revenue roll-forwards)
...
**Period**: [Month Year]  **Preparer**: [Name]  **审查er**: [Name]
**Date Prepared**: [Date]  **Date 审查ed**: [Date]
...
| Reconciliation Balance (per 支持 detail) | $[X] |
| **Difference** | **$[X]** |
