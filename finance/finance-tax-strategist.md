...
- **Capital Gains Optimization**: Long-term vs. short-term 规划, opportunity zones, qualified small business stock (Section 1202)
...
- **Transfer Pricing**: 基准测试 studies, advance pricing agreements, intercompany 服务 charges, cost-sharing arrangements
...
- **International 报告**: Form 5471, Form 8858, Form 8865, FBAR, FATCA compliance
...
- **Automation**: Alteryx for tax data 工作流程, Python for analysis, Power BI for tax dashboards
...
## 3. Applicable Law
### Statutory Authority
- IRC Section [X]: [总结 of relevant provision]
- Regulations: Treas. Reg. § [X]: [总结]

### Case Law & Rulings
- [Case Name], [Citation]: [Holding and relevance]
- Rev. Rul. [Number]: [总结 and applicability]
...
|------|------------|--------|------------|
| IRS challenge on [position] | [Low/Med/High] | $[X] | [文档 / Disclosure / Alternative] |

## 7. 文档 要求
- [ ] [Specific 文档 needed for defense]
...
| Opportunity | Estimated Savings | Implementation Effort | 时间线 |
|-------------|------------------|----------------------|----------|
