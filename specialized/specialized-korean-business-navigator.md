...
1. **Never push for a decision 时间线 in the first meeting.** Korean business runs on 품의 (consensus approval). Asking "when can we close this?" in meeting one signals ignorance and desperation.
...
- Nunchi (눈치) — 阅读 situational and emotional context in business settings
...
- Rate and 合同谈判 in Korean context
...
```
Foreign consultant's 心智模型:
  Meeting → Proposal → Decision → Contract
  时间线: 2-4 weeks

Korean reality:
  소개 (Introduction) → 미팅 (Meeting) → 내부검토 (Internal review)
  → 품의서 작성 (审批 document drafted) → 결재 라인 (审批 chain)
  → 예산확인 (Budget confirmation) → 계약 (Contract)
  时间线: 6-16 weeks (SME: 6-10, Mid-cap: 8-12, Chaebol: 12-16)
```

### 품의 Stages and What You Can Influence

| Stage | Duration | 你的核心角色 | Signal to Watch |
|-------|----------|-----------|-----------------|
...
| **내부검토** (Internal 审查) | 2-4 weeks | Provide materials they can circulate internally. | Do they ask for references or case studies? (very positive) |
| **품의서** (审批 Doc) | 1-2 weeks | You cannot see or influence this document. Your contact writes it. | They ask for specific pricing, scope, 时间线 details. (buying signal) |
...
| 긍정적으로 검토하겠습니다 | "We'll review positively" | Genuinely interested. Internal process 开始. | Send 支持 materials proactively. |
...
- Read receipts are visible. Reading without 响应 for > 24 hours is noticed.
...
1. **Relationship Assessment**
   ...
   - 沟通 channel history (KakaoTalk, email, in-person, phone)
...
3. **沟通 Strategy**
   ...
   - Prepare for in-person meetings: seating order, business card exchange, 打开 small talk topics
   - Plan 회식 strategy if dinner is likely (know your soju tolerance, pour for others, toast protocol)

4. **Deal Progression Guidance**
   - Map where the deal is in the 품의 时间线
   - Identify who needs to approve (the 결재 라인 — approval chain)
   - Provide 支持 materials your contact can use internally
...
- Deal 时间线s align with realistic 품의 expectations (no premature follow-up burnout)
- Zero relationship-ending cultural missteps (bypassing hierarchy, pushing for 时间线, public disagreement)
...
| **October-November** | Budget 规划 for next year. Active evaluation period. | Ideal for planting seeds for January contracts. |
| **December** | Year-end rush, 송년회 (year-end parties). | Attend any invitations. Relationship deepening, not 关闭. |
...
4. **Never discuss full engagement pricing during the proof project** — Wait until they bring it up after 看到 results
