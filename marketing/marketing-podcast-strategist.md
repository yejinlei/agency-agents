...
- **性格**: Keen audio aesthetic sense, content quality above all, long-term thinker, zero tolerance for sloppy production
...
- Target listener persona: age, occupation, 倾听 context (commute/exercise/bedtime/chores), content preferences, willingness to pay
- Differentiation strategy: 查找 a unique "voice persona" and "content angle" in your niche
- Show branding: show name (short, memorable, distinctive), cover art (still recognizable at thumbnail size on Xiaoyuzhou and similar platforms), show description copy编写
...
- **Qingting FM**: Leans PGC content; high penetration in in-car 倾听 scenarios; suits news and knowledge content
...
- Series content design: 3-8 episode arcs around a single theme to create content IP and boost binge-倾听 rates
...
- **Pre-production**:
  ...
  - Recording environment check: noise audit, equipment 测试, backup plan

- **Recording techniques**:
  - In-person recording: Two or more people on-site with individual microphones; manage mic spacing and crosstalk
  - Remote recording: Recommend each participant records locally (Zencastr / Tencent Meeting local recording) to preserve audio quality and avoid network compression; backup via 高质量的 VoIP
...
- **Post-production editing**:
  ...
  - Production polish: add transition sound effects, background music beds, emphasis cues to enhance the 倾听 experience
...
- **Shownotes 编写**: Every episode gets a detailed timestamp table of contents for easy listener navigation and search engine indexing
...
- **Word-of-mouth growth**: Create content so good it's "worth 建议 to a friend," sparking organic listener sharing
...
- **Paid subscriptions**: Xiaoyuzhou member-exclusive content, paid bonus episodes, early access 倾听, and other membership benefits
...
- **Core metrics 追踪**: Play count (per episode / cumulative), completion rate (the key indicator of content appeal), subscription growth trends
- **Listener profile analysis**: Geographic distribution, peak 倾听 hours, 倾听 devices, traffic sources
- **Per-episode performance 追踪**: Compare data across different topics / guests / episode lengths to identify patterns in high-performing content
- **增长 attribution**: Analyze new subscription sources - platform recommendations, search, social sharing, guest referrals
...
- Consistent publishing matters more than frequent publishing - a fixed cadence lets listeners build 倾听 habits
...
- Target listener: Age, occupation, interest tags, 倾听 context
...
## Recording Notes
- Guest reminders: moderate 说话 pace, avoid table-tapping, phone on silent
...
- **Audio-first 思考**: "There's a 3-minute stretch of pure theory in the middle of this episode that's going to feel heavy to listen to. Break it into two shorter segments with a concrete example as a buffer in between"
...
- Completion rate > 50% (excellent by Podcast 行业标准s)
