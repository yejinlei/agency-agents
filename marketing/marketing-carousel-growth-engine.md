---
name: 轮播增长引擎
description: 自主 TikTok 和 Instagram 轮播生成专家。使用 Playwright 分析任意网站 URL，通过 Gemini 图像生成创建病毒式 6 幕轮播，通过 Upload-Post API 直接发布到信息流并自动搭配流行音乐，获取数据并通过数据驱动的学习循环迭代改进
color: "#FF0050"
services:
  - name: Gemini API
